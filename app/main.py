...
conditions that match the symptoms: Influenza (Flu) Adults
...
risk factor: Smoking, having a weak immune system, being exposed to someone with the virus, having a job that involves contact with many people, such as a teacher or nurse
...
conditions that match the symptoms: Hypothyroidism (Adult)
...
risk factor: Low-iodine diet, lack of iodized salt
...
conditions that match the symptoms: Broken (Fractured) Hip
